...
class BuscaCepViniRod extends StatefulWidget {
  const BuscaCepViniRod({super.key});

  @override
  State<BuscaCepViniRod> createState() => _BuscaCepViniRodState();
}

final TextEditingController _cepController = TextEditingController();
final HomeController homeController = HomeController();

class _BuscaCepViniRodState extends State<BuscaCepViniRod> {
  @override
  void initState() {
